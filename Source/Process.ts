...
export class Process {
    private AkaDatabase: Database;
    private RequestData: Request;

    constructor(RequestData: Request, Environment: Env) {
        this.AkaDatabase = new Database(Environment.DB);
    ...
    public async Process(): Promise<Response> {
        ...
        if (this.RequestData.method === "GET") {
            ...
            let APIInstance = new API(this.AkaDatabase, PathName, RequestJSON);
